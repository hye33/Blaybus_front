...
export function Drone({ d = 0, x = 0, y = 0, z = 0, setSelected, ...props }) {
  const assemble = useGLTF('/models/Drone.glb')
  const explode = useGLTF('/models/Drone_ex.glb')
  ...
  return (
    <group
      position={[-0.1, 0.2, 0]}
      rotation={[radian * x, radian * -155, radian * z]}
      scale={0.7}
      >
      {partNames.map(name => {
...
useGLTF.preload('/models/Drone_ex.glb')